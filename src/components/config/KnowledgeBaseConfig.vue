<template>
  <div class="config-form">
    <div class="section-desc">
      <p>{{ t('system.config.knowledge.description') }}</p>
    </div>
    
    <!-- Open WebUI URL -->
    <div class="form-item">
      <label class="form-label">{{ t('system.config.knowledge.url') }}</label>
      <el-input
        v-model="config.openwebuiUrl"
    ...
    <!-- Open WebUI API Key -->
    <div class="form-item">
      <label class="form-label">{{ t('system.config.knowledge.apiKey') }}</label>
      <el-input
        v-model="config.openwebuiApiKey"
        type="password"
        show-password
        :placeholder="hasApiKey ? t('system.config.knowledge.apiKeyConfigured') : t('system.config.knowledge.apiKeyPlaceholder')"
