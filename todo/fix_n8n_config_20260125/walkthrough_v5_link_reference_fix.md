...
*   **[FIX] Reference Indexing**: Fixed a bug where scanned/fallback documents were not appearing in the "Reference Documents" section because they lacked an index. Now assigns synthetic indices to ensure they are listed and linked correctly.
...
2.  **Functional Test**:
    ...
    *   **Expectation**: 
        ...
        *   "Reference Documents" section is correctly generated at the bottom.
